...
extern static_name_t key_preset_add_dialog_group_name;
extern static_name_t key_preset_add_dialog_message;
extern static_name_t key_preset_add_dialog_name;
extern static_name_t key_preset_add_subdialog_cancel_button_alt_text;
extern static_name_t key_preset_add_subdialog_default_preset_name;
extern static_name_t key_preset_add_subdialog_ok_button_alt_text;
extern static_name_t key_preset_category_popup_alt_text;
extern static_name_t key_preset_category_popup_name;
extern static_name_t key_preset_custom_category_name;
extern static_name_t key_preset_delete_dialog_message;
extern static_name_t key_preset_delete_dialog_name;
extern static_name_t key_preset_delete_subdialog_cancel_button_alt_text;
extern static_name_t key_preset_delete_subdialog_ok_button_alt_text;
extern static_name_t key_preset_file_extension;
extern static_name_t key_preset_menu_item_add_preset;
extern static_name_t key_preset_menu_item_append_preset;
extern static_name_t key_preset_menu_item_delete_preset;
extern static_name_t key_preset_preset_popup_alt_text;
extern static_name_t key_preset_preset_popup_name;
extern static_name_t key_preset_subdialog_cancel_button_name;
extern static_name_t key_preset_subdialog_ok_button_name;
extern static_name_t key_preset_top_folder_name;
extern static_name_t key_preset_user_preset_list_empty_warning;
extern static_name_t key_preset_user_presets_category_name;

// The following are the names given to the structural components of the presets in memory.
extern static_name_t key_preset_value; // The dictionary of property values for a single preset
extern static_name_t key_preset_name;  // The names of the categories and the presets themselves
extern static_name_t key_preset_items; // The set of presets listed for a single category
