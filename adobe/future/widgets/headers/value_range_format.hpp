...
public:
    ...
    void set(const dictionary_t& parameters)
    {
        ...
        double interval_count_double(last_m - first_m);
        get_value(parameters, key_interval_count, interval_count_double);
        interval_count_m = static_cast<std::size_t>(interval_count_double);
    }
