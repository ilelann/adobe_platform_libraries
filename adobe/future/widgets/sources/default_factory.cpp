...
#include <adobe/future/widgets/headers/control_button_factory.hpp>
#include <adobe/future/widgets/headers/display_number_factory.hpp>
#include <adobe/future/widgets/headers/display.hpp>
#include <adobe/future/widgets/headers/edit_number_factory.hpp>
...
// Can't be in the annonymous namespace because used with template instantiations.
...
{
    adobe::poly_placeable_t *p(new adobe::poly_placeable_t(adobe::implementation::noncreating_placeable_t()));
    ...
    token.client_holder_m.assemblage_m.cleanup(boost::bind(adobe::delete_ptr(), p));
