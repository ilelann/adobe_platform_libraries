...
template <typename Backend>
void on_button_clicked(button<Backend>& element, const modifiers_t & modifiers)
{
...
template <typename Backend>
typename Backend::widget_handle do_insert(display_t& display, typename Backend::widget_handle& parent, button<Backend>& element)
{
    Backend::pre(element);
