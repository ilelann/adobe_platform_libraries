...
struct gtk
{
    ...
    using connection_handle = gulong;

    struct debounce
    {
        debounce(widget_handle widget, connection_handle connection);
        ~debounce();
    ...
    private:
        widget_handle     widget_m;
        connection_handle connection_m;
    };
    ...
    static void set_visible(widget_handle widget, bool visible);

    static void set_control_alt_text(widget_handle widget, const std::string& text);

    /****************************************************************************************************/

    static void measure(widget_handle widget, extents_t& result);

    static void place(widget_handle widget, const place_data_t& place_data);

    static void measure_vertical(widget_handle widget, extents_t& e, const place_data_t& d);
    ...
    static widget_handle post(widget_handle& parent, const widget_handle& element);
};
} // namespace implementation
